...
-   `pollution_rate` detrimental effect of the environment on the wild type (i.e., the wild-type population pollutions at this rate; should be \>0 to induce potential extinction)
...
*reproduction: $a$ individuals always suffer from the pollution rate, independent of the current population size; the growth rate of $A$ individuals decreases to 1 as the carrying capacity is approached
*mutation occurs
...
decay_rate <- 0.1
sel_coeff <- 0.3
mut_rate <- seq(0.001, 0.1, by = 0.001)  # Sequence of mutation rates to test
mig_rate_a <- 3
t_max <- 1000
n_reps <- 1000
