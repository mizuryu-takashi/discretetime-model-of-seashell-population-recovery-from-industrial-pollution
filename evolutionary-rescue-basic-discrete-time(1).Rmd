...
simulate_pop <- function(N_bw, N_bm, pollution_rate, sel_coeff, migra_rate, mut_rate, t_max) {
  ...
  for (i in 1:t_max+1) {
    ...
    pop_new <- simulate_one_gen_mig_logistic(pop_new[1],pop_new[2],carrying_capacity, pollution_rate, sel_coeff, migra_rate, mut_rate, t_max)
...
output <- simulate_pop(1000, 0, 1000, 0.7, 0.2, 0.2, 0.01, max_gen)
...
print(pop_new[1]=1000,pop_new[2]=0,carrying_capacity=1000, pollution_rate=.7, sel_coeff=.2, migra_rate=.2, mut_rate=.01, max_gen)
``` 
