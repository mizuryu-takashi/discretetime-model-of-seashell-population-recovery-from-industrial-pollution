...
# set t_max to a value to be used througout
# this plots the total population size
plot(table_avg[,1], table_avg [,2],type='l',ylim=c(0,max(table_avg [,2])),xlab = "Migration Rate",ylab = "Time to carrying capacity")
...
# Plot the results
  plot(table_avg_a[,1], table_avg_a[,2], type= 'l', col= "blue", ylim= c(0, max(table_avg_a[,2], table_avg_b[,2], table_avg_c[,2])), xlab = "Migration Rate", ylab= "Time to Carrying Capacity", main = "Comparison of Decay Rates")
...
# Add the line for decay_rate = 0.5
  ...
  # Add a legend
legend("topright", legend = c("decay_rate = 0.1", "decay_rate = 0.15", "decay_rate = 0.2"), col = c("blue", "red", "purple"), lty = 1)
...
In the event of an increase in the number of migrants, what is the estimated timeframe for reaching the carrying capacity? Furthermore, it would be beneficial to ascertain how the decay rate may influence this outcome.
